...
const cssLoaderOptions = {
  ...
  getLocalIdent: (context, localIdentName, localName) => {
    ...
    const match = context.resourcePath.match(/(layouts|pages|componentWebs)(.*)/);
  ...
  webpack: (config, { buildId, dev, isServer, defaultLoaders }) => {
    ...
    if (isProd) {
      ...
      config.plugins.push(new CopyWebpackPlugin([
        ...
        // { from: './static/public/ckeditor', to: 'static/plugins/ckeditor' },
        // { from: './static/public/RichFileManager', to: 'static/plugins/RichFileManager' },
        // { from: './static/public/image-editor', to: 'static/plugins/image-editor' },
      ],
      ...
      config.plugins.push(new CopyWebpackPlugin([
        { from: './static', to: 'static' },
        // { from: './static/web/images', to: 'static/images' },
        // { from: './static/public/ckeditor', to: 'static/plugins/ckeditor' },
        // { from: './static/public/RichFileManager', to: 'static/plugins/RichFileManager' },
        // { from: './static/public/image-editor', to: 'static/plugins/image-editor' },
      ],
